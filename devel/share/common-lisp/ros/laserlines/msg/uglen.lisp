...
;//! \htmlinclude uglen.msg.html

(cl:defclass <uglen> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass uglen (<uglen>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <uglen>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'uglen)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laserlines-msg:<uglen> is deprecated: use laserlines-msg:uglen instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <uglen>))
...
(cl:defmethod angle_min-val ((m <uglen>))
...
(cl:defmethod angle_max-val ((m <uglen>))
...
(cl:defmethod angle_increment-val ((m <uglen>))
...
(cl:defmethod ranges-val ((m <uglen>))
  ...
  (ranges m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <uglen>) ostream)
  "Serializes a message object of type '<uglen>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <uglen>) istream)
  "Deserializes a message object of type '<uglen>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<uglen>)))
  "Returns string type for a message object of type '<uglen>"
  "laserlines/uglen")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'uglen)))
  "Returns string type for a message object of type 'uglen"
  "laserlines/uglen")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<uglen>)))
  "Returns md5sum for a message object of type '<uglen>"
  "0aa13076bebd983925adfce2780dac6e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'uglen)))
  "Returns md5sum for a message object of type 'uglen"
  "0aa13076bebd983925adfce2780dac6e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<uglen>)))
  "Returns full string definition for message of type '<uglen>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'uglen)))
  "Returns full string definition for message of type 'uglen"
  (cl:format cl:nil "Header header~%float32 angle_min~%float32 angle_max~%float32 angle_increment~%float32[] ranges~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <uglen>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <uglen>))
