...
;//! \htmlinclude LaserMsg.msg.html

(cl:defclass <LaserMsg> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass LaserMsg (<LaserMsg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <LaserMsg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'LaserMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laserlines-msg:<LaserMsg> is deprecated: use laserlines-msg:LaserMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <LaserMsg>))
...
(cl:defmethod angle_min-val ((m <LaserMsg>))
...
(cl:defmethod angle_max-val ((m <LaserMsg>))
...
(cl:defmethod angle_increment-val ((m <LaserMsg>))
...
(cl:defmethod ranges-val ((m <LaserMsg>))
  ...
  (ranges m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LaserMsg>) ostream)
  "Serializes a message object of type '<LaserMsg>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LaserMsg>) istream)
  "Deserializes a message object of type '<LaserMsg>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LaserMsg>)))
  "Returns string type for a message object of type '<LaserMsg>"
  "laserlines/LaserMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LaserMsg)))
  "Returns string type for a message object of type 'LaserMsg"
  "laserlines/LaserMsg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LaserMsg>)))
  "Returns md5sum for a message object of type '<LaserMsg>"
  "0aa13076bebd983925adfce2780dac6e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LaserMsg)))
  "Returns md5sum for a message object of type 'LaserMsg"
  "0aa13076bebd983925adfce2780dac6e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LaserMsg>)))
  "Returns full string definition for message of type '<LaserMsg>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LaserMsg)))
  "Returns full string definition for message of type 'LaserMsg"
  (cl:format cl:nil "Header header~%float32 angle_min~%float32 angle_max~%float32 angle_increment~%float32[] ranges~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LaserMsg>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LaserMsg>))
