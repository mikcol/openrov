"""autogenerated by genpy from laserlines/LaserMsg.msg. Do not edit."""
import sys
...
class LaserMsg(genpy.Message):
  _md5sum = "0aa13076bebd983925adfce2780dac6e"
  _type = "laserlines/LaserMsg"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,angle_min,angle_max,angle_increment,ranges
    ...
    """
    if args or kwds:
      super(LaserMsg, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3f.pack(_x.angle_min, _x.angle_max, _x.angle_increment))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.angle_min, _x.angle_max, _x.angle_increment,) = _struct_3f.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
